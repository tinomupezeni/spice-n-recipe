      ...
      <>
        <div className="footer">
          ...
          <div className="bottom">
            <p>
              for website designing please use the above contact information
            </p>
            <p>
              our goal as spice'n recipe is to give clients a better
              understanding of spices, their health benefits and also recipes to
              try out
            </p>
          </div>
        </div>
